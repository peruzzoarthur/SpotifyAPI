...
export const logout = () => {
  ...
  window.location = window.location.origin as string & Location;
};
...
// TODO
// Try to implement the logic from the SDK
 ...
 * @returns {Promise}
 */
export const getPlaylistById = (playlist_id: any) => {
 ...
 * @returns {Promise}
 */
export const getAudioFeaturesForTracks = (ids: any) => {
